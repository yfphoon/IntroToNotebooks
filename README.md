...
This repository contains data and analytic assets for the Lab. The iPython Notebook is designed to run on <a href="datascience.ibm.com">IBM Data Science Experience</a> and analyzes the churn.csv and customer.csv data sets.
